	...
	<div class="container">
			...
			<div class="row" style="">
				<div class="col" style="color:;">
								<h2 style="	color:rgb(227, 87, 46);"><a href="home.php" style="color:rgb(227,87,46)">Home</a> >> <i class="fa-solid fa-plug-circle-bolt me-2"></i>Electronics</h2>
							</div>
			</div>
